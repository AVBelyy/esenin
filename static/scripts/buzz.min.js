...
function(d,b){if(!e)return this;d=d.split(" ");for(var a=this,g=function(d){b.call(a,d)},c=0;c<d.length;c++){var f=d[c],j=f,f=j.split(".")[0];h.push({idx:j,func:g});this.sound.addEventListener(f,g,!0)}return this};this.unbind=function(d){if(!e)return this;d=d.split(" ");for(var b=0;b<d.length;b++)for(var a=d[b],g=a.split(".")[0],c=0;c<h.length;c++){var f=h[c].idx.split(".");if(h[c].idx==a||f[1]&&f[1]==a.replace(".",""))this.sound.removeEventListener(g,h[c].func,!0),h.splice(c,1)}return this};this.bindOnce=
...
b?(j.setVolume(j.volume+=1),c()):f>b&&j.volume>b?(j.setVolume(j.volume-=1),c()):g instanceof Function&&g.apply(j)},h)}if(!e)return this;a instanceof Function?(g=a,a=buzz.defaults.duration):a=a||buzz.defaults.duration;var f=this.volume,h=a/Math.abs(f-b),j=this;this.play();this.whenReady(function(){c()});return this};this.fadeIn=function(b,a){return!e?this:this.setVolume(0).fadeTo(100,b,a)};this.fadeOut=function(b,a){return!e?this:this.fadeTo(0,b,a)};this.fadeWith=function(b,a){if(!e)return this;this.fadeOut(a,
function(){this.stop()});b.play().fadeIn(a);return this};this.whenReady=function(b){if(!e)return null;var a=this;0===this.sound.readyState?this.bind("canplay.buzzwhenready",function(){b.call(a)}):b.call(a)};if(e&&c){for(var l in buzz.defaults)buzz.defaults.hasOwnProperty(l)&&(a[l]=a[l]||buzz.defaults[l]);this.sound=document.createElement("audio");if(c instanceof Array)for(var m in c)c.hasOwnProperty(m)&&b(this.sound,c[m]);else if(a.formats.length)for(var n in a.formats)a.formats.hasOwnProperty(n)&&
b(this.sound,c+"."+a.formats[n]);else b(this.sound,c);a.loop&&this.loop();a.autoplay&&(this.sound.autoplay="autoplay");this.sound.preload=!0===a.preload?"auto":!1===a.preload?"none":a.preload;this.setVolume(a.volume);buzz.sounds.push(this)}},group:function(c){function a(){for(var b=f(null,arguments),a=b.shift(),h=0;h<c.length;h++)c[h][a].apply(c[h],b)}function f(a,c){return a instanceof Array?a:Array.prototype.slice.call(c)}c=f(c,arguments);this.getSounds=function(){return c};this.add=function(a){a=
...
this.unbind=function(b){a("unbind",b);return this};this.bindOnce=function(b,c){a("bindOnce",b,c);return this};this.trigger=function(b){a("trigger",b);return this};this.fade=function(b,c,f,k){a("fade",b,c,f,k);return this};this.fadeIn=function(b,c){a("fadeIn",b,c);return this};this.fadeOut=function(b,c){a("fadeOut",b,c);return this}},all:function(){return new buzz.group(buzz.sounds)},isSupported:function(){return!!buzz.el.canPlayType},isOGGSupported:function(){return!!buzz.el.canPlayType&&buzz.el.canPlayType('audio/ogg; codecs="vorbis"')},
